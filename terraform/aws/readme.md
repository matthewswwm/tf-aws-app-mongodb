...
| Name | Type |
|------|------|
| [aws_eip.eks_private_nat](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/eip) | resource |
...
| [aws_nat_gateway.eks_private](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/nat_gateway) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_additional_public_cidrs"></a> [additional\_public\_cidrs](#input\_additional\_public\_cidrs) | For dynamically adding more security groups to support additional CIDRs. Note the ingress rule will be for all protocols and ports | `list(any)` | `null` | no |
| <a name="input_aws_availability_zone_list"></a> [aws\_availability\_zone\_list](#input\_aws\_availability\_zone\_list) | A list of availability zones within the provider region the resources will be running, e.g. eu-west-1a and ap-southeast-1b. Minimum 2 are needed for the EKS setup | `list(string)` | <pre>[<br/>  "eu-west-2a",<br/>  "eu-west-2b"<br/>]</pre> | no |
| <a name="input_aws_region"></a> [aws\_region](#input\_aws\_region) | AWS region to use | `string` | `"eu-west-2"` | no |
| <a name="input_eks_cluster_name"></a> [eks\_cluster\_name](#input\_eks\_cluster\_name) | Name of the EKS cluster | `string` | n/a | yes |
| <a name="input_eks_cluster_ver"></a> [eks\_cluster\_ver](#input\_eks\_cluster\_ver) | Version of the EKS cluster | `string` | `"1.35"` | no |
| <a name="input_eks_private_subnet_cidrs"></a> [eks\_private\_subnet\_cidrs](#input\_eks\_private\_subnet\_cidrs) | List of CIDRs for EKS private subnet | `list(string)` | `[]` | no |
| <a name="input_eks_public_subnet_cidrs"></a> [eks\_public\_subnet\_cidrs](#input\_eks\_public\_subnet\_cidrs) | List of CIDRs for EKS public subnet | `list(string)` | `[]` | no |
...
| <a name="input_instance_subnet_cidr"></a> [instance\_subnet\_cidr](#input\_instance\_subnet\_cidr) | The cidr block range of IP addresses for the EC2 instance subnet | `string` | `"192.0.0.0/24"` | no |
